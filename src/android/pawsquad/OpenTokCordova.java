...
//  PublisherKit.PublisherListener, Session.SubscriberListener
...
public class OpenTokCordova extends CordovaPlugin implements
  Session.SessionListener, Session.ConnectionListener, Session.SignalListener,
    ...
    public void run() {
      try {
        ...
        // Ratios are index 6 & 7 on TB.updateViews, 8 & 9 on subscribe event, and 9 & 10 on TB.initPublisher
          ...
          Log.e(TAG, "error when trying to retrieve properties while resizing properties");
      }
    }
  }
    ...
    public void onStreamCreated(PublisherKit arg0, Stream arg1) {
      try {
        if ( compareStrings(this.mProperty.getString(8), "back") ) {
          ...
          Log.e(TAG, "error when trying to retrieve cameraName property");
      }
  ...
  public void onConnected(Session arg0) {
    if (mSession == null || mSession.getConnection() == null) {
      Log.e(TAG, "OMG SESSION IS NULL");
      return;
    }

    try{

    Log.e(TAG, "session connected, triggering sessionConnected Event. My Cid is: " +
  ...
  public void onStreamDropped(Session arg0, Stream arg1) {
    Log.e(TAG, "session dropped stream");
    streamCollection.remove( arg1.getStreamId() );
  ...
  public void onConnectionDestroyed(Session arg0, Connection arg1) {
    Log.e(TAG, "connection dropped: " + arg1.getConnectionId());
  ...
  public void onSignalReceived(Session arg0, String arg1, String arg2, Connection arg3) {
    JSONObject data = new JSONObject();
    Log.e(TAG, "signal type: " + arg1);
    Log.e(TAG, "signal data: " + arg2);
